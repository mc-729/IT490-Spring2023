...
<head>
    ...
    <head>
            ...
            <div class="container-fluid">
                ...
                <form action="edit-profile.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="password" name="curPW" id="curPW" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="password" name="conPW" id="conPW" />
                    </div>
        ...
        if ($hasError) {
            echo '<script>alert("Bruhhhhhh Alert!!!!!!")</script>';
        }
        if (
